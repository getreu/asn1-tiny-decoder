...
In link:data/asn1tinydecoder.py[`asn1tinydecoder.py`] a "`node`" is a pointer to an 
...
NOTE: All functions of link:data/asn1tinydecoder.py[`asn1tinydecoder.py`] are stateless.  
...
Download `asn1tinydecoder.py` link:data/asn1tinydecoder.py[here].
...
link:data/search_serial_in_large_CRL.py[`search_serial_in_large_CRL.py`]
